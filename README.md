...
| **4** | **Jupyter notebook export** | Export `.ipynb` + `dataset.csv` + `model.graph.json` as a reproducible PyTorch training bundle. Run in JupyterLab, Colab, or JupyterLite — weights transfer back to the browser. |
