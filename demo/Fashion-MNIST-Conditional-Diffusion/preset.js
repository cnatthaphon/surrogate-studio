    ...
    evaluations: [
      {
        ...
        generationConfig: { runtime: "client", method: "ddpm", numSamples: 64, steps: 50, lr: 0.01, temperature: 1.0, seed: 42, targetClass: -1 },
        status: "draft",
        runs: [],
        createdAt: Date.now(),
      },
      {
        id: "e-cond-reconstruction-quality",
      ...
      },
      {
        ...
        runMode: "generate",
        weightSelection: "last",
        generationConfig: { runtime: "client", method: "ddpm", numSamples: 32, steps: 50, lr: 0.01, temperature: 1.0, seed: 42, targetClass: 0 },
        status: "draft",
        runs: [],
        createdAt: Date.now(),
      },
