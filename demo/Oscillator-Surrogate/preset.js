  ...
  window.OSCILLATOR_DEMO_PRESET = {
    ...
    trainers: [
      ...
      { id: "demo-osc-den-t", name: "Denoiser Trainer", schemaId: "oscillator", datasetId: "demo-osc-ds", modelId: "demo-osc-denoiser", status: "draft",
        config: { epochs: 30, batchSize: 32, learningRate: 0.001, optimizerType: "adam", useServer: true } },
      // Pre-trained (PyTorch CUDA, 20 epochs, 300 trajectories)
      { id: "demo-osc-mlp-pre", name: "Direct-MLP (pre-trained)", schemaId: "oscillator", datasetId: "demo-osc-ds", modelId: "demo-osc-mlp", status: "done",
        _pretrainedVar: "OSC_MLP_PRETRAINED_BIN_B64",
        config: { epochs: 30, batchSize: 32, learningRate: 0.001, optimizerType: "adam" } },
      { id: "demo-osc-gru-pre", name: "AR-GRU (pre-trained)", schemaId: "oscillator", datasetId: "demo-osc-ds", modelId: "demo-osc-gru", status: "done",
        _pretrainedVar: "OSC_GRU_PRETRAINED_BIN_B64",
        config: { epochs: 30, batchSize: 32, learningRate: 0.001, optimizerType: "adam" } },
      { id: "demo-osc-vae-pre", name: "VAE (pre-trained)", schemaId: "oscillator", datasetId: "demo-osc-ds", modelId: "demo-osc-vae", status: "done",
        _pretrainedVar: "OSC_VAE_PRETRAINED_BIN_B64",
        config: { epochs: 30, batchSize: 32, learningRate: 0.0005, optimizerType: "adam" } },
      { id: "demo-osc-vae-cls-pre", name: "VAE+Classifier (pre-trained)", schemaId: "oscillator", datasetId: "demo-osc-ds", modelId: "demo-osc-vae-cls", status: "done",
        _pretrainedVar: "OSC_VAE_CLS_PRETRAINED_BIN_B64",
        config: { epochs: 30, batchSize: 32, learningRate: 0.0005, optimizerType: "adam" } },
      { id: "demo-osc-den-pre", name: "Denoiser (pre-trained)", schemaId: "oscillator", datasetId: "demo-osc-ds", modelId: "demo-osc-denoiser", status: "done",
        _pretrainedVar: "OSC_DENOISER_PRETRAINED_BIN_B64",
        config: { epochs: 30, batchSize: 32, learningRate: 0.001, optimizerType: "adam" } },
    ],
    generations: [
      { id: "demo-osc-vae-gen", name: "VAE Reconstruct", schemaId: "oscillator", trainerId: "demo-osc-vae-pre", family: "vae",
        config: { method: "reconstruct", numSamples: 16, seed: 42 }, status: "draft", runs: [], createdAt: Date.now() },
      { id: "demo-osc-cls-gen", name: "Classifier-Guided", schemaId: "oscillator", trainerId: "demo-osc-vae-cls-pre", family: "vae",
      ...
      { id: "demo-osc-lang-gen", name: "Langevin Sampling", schemaId: "oscillator", trainerId: "demo-osc-den-pre", family: "diffusion",
        config: { method: "langevin", numSamples: 8, steps: 50, lr: 0.01, temperature: 0.5, seed: 42 }, status: "draft", runs: [], createdAt: Date.now() },
    ],
    evaluations: [
      { id: "demo-osc-eval", name: "Surrogate Benchmark (pre-trained)", schemaId: "oscillator", datasetId: "demo-osc-ds",
        trainerIds: ["demo-osc-mlp-pre", "demo-osc-gru-pre", "demo-osc-vae-pre", "demo-osc-vae-cls-pre", "demo-osc-den-pre"],
        evaluatorIds: ["mae", "rmse", "r2", "bias"], runMode: "test", weightSelection: "best",
        status: "draft", runs: [], createdAt: Date.now() },
      { id: "demo-osc-eval-all", name: "All Models Benchmark", schemaId: "oscillator", datasetId: "demo-osc-ds",
