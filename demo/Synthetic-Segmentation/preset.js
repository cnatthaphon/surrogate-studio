...
(function () {
  ...
  function buildSegUNetAug() {
    ...
    var imgSrc  = N(d, "image_source", { sourceKey: "pixel_values", featureSize: IMAGE_SIZE, imageShape: [32,32,1] }, 50, 300);
    var reshape = N(d, "reshape",      { targetShape: "32,32,1" },            200, 300);
    var augImg  = N(d, "augment_image",{ hflipProb: 0.5, vflipProb: 0, seedLink: "segshape_aug", layout: "auto" }, 320, 300);
    ...
    var augMask  = N(d, "augment_mask", { hflipProb: 0.5, vflipProb: 0, seedLink: "segshape_aug", layout: "auto" }, 1170, 550);
