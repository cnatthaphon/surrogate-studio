...
(function () {
  ...
  window.FASHION_MNIST_GAN_PRESET = {
    ...
    trainers: [
      ...
      // clipWeights=0.01 (paper value) and epochs=2000 to give the generator
      // enough updates to catch up under the tighter Lipschitz constraint.
      { id: "t-mlp-wgan", name: "MLP-WGAN Trainer", schemaId: sid, datasetId: DS, modelId: "m-mlp-wgan", status: "draft",
        config: { epochs: 2000, batchSize: 128, learningRate: 0.00005, optimizerType: "rmsprop", useServer: true,
                  earlyStoppingPatience: 0, lrSchedulerType: "none", weightSelection: "last",
                  trainingSchedule: [
                    { unit: "batch", batches: 5, trainableTags: { discriminator: true, generator: false }, clipWeights: 0.01 },
                    { unit: "batch", batches: 1, trainableTags: { discriminator: false, generator: true } }
                  ], rotateSchedule: true } },
      ...
      { id: "t-mlp-wgan-trained", name: "MLP-WGAN (pre-trained)", schemaId: sid, datasetId: DS, modelId: "m-mlp-wgan", status: "done",
        ...
        // Arjovsky-faithful: clipWeights=0.01 (paper value, was 0.1) keeps the
        // critic 1-Lipschitz-bounded much more tightly, which gave us the
        // cleanest converged basin in this session. 2000 epochs (was 1000) so
        // the generator catches up — at 1000 epochs the magnitudes were small
        // but the visuals still trended toward textured noise.
        config: { epochs: 2000, batchSize: 128, learningRate: 0.00005, optimizerType: "rmsprop", useServer: true,
                  earlyStoppingPatience: 0, lrSchedulerType: "none", weightSelection: "last", seed: 42,
                  trainingSchedule: [
                    { unit: "batch", batches: 5, trainableTags: { discriminator: true, generator: false }, clipWeights: 0.01 },
                    { unit: "batch", batches: 1, trainableTags: { discriminator: false, generator: true } }
                  ], rotateSchedule: true } },
