...
(function () {
  ...
  window.FASHION_MNIST_UNET_PRESET = {
    ...
    trainers: [
      {
        id: "unet_pretrained", name: "UNet (pre-trained)", schemaId: sid,
        datasetId: DS_ID, modelId: "unet_model",
        runtime: "server_pytorch", runtimeBackend: "auto", status: "done",
        _pretrainedVar: "UNET_PRETRAINED_WEIGHTS",
        trainCfg: { epochs: 200, batchSize: 64, learningRate: 0.001, optimizer: "adam", earlyStoppingPatience: 30, lrPatience: 10, lrFactor: 0.5, minLr: 1e-6, restoreBestWeights: true },
        metrics: { mae: 0.0076, testMae: 0.0076, bestValLoss: 0.000101, bestEpoch: 197 },
      },
      {
        id: "conv_ae_pretrained", name: "Conv AE (pre-trained)", schemaId: sid,
        datasetId: DS_ID, modelId: "conv_ae_model",
        runtime: "server_pytorch", runtimeBackend: "auto", status: "done",
        _pretrainedVar: "CONV_AE_PRETRAINED_WEIGHTS",
        trainCfg: { epochs: 200, batchSize: 64, learningRate: 0.001, optimizer: "adam", earlyStoppingPatience: 30, lrPatience: 10, lrFactor: 0.5, minLr: 1e-6, restoreBestWeights: true },
        metrics: { mae: 0.027, testMae: 0.027, bestValLoss: 0.00249, bestEpoch: 200 },
      },
      {
    ...
    evaluations: [
      {
        ...
        trainerIds: ["unet_pretrained", "conv_ae_pretrained"],
