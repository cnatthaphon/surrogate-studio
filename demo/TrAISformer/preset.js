...
(function () {
  ...
  window.TRAISFORMER_PRESET = {
    ...
    trainers: [
      ...
      { id: "t-tiny-trais-pre", name: "Tiny TrAISformer (pre-trained)", schemaId: sid, datasetId: DS, modelId: "m-tiny-trais", status: "done",
        _pretrainedVar: "TINY_TRAIS_PRETRAINED_BIN_B64",
        config: { epochs: 20, batchSize: 256, learningRate: 0.001, optimizerType: "adam" } },
      { id: "t-small-trais-pre", name: "Small TrAISformer (pre-trained)", schemaId: sid, datasetId: DS, modelId: "m-small-trais", status: "done",
        _pretrainedVar: "SMALL_TRAIS_PRETRAINED_BIN_B64",
        config: { epochs: 20, batchSize: 256, learningRate: 0.001, optimizerType: "adam" } },
    ],
    generations: [],
    evaluations: [
      {
        ...
        schemaId: sid,
        datasetId: DS,
        trainerIds: ["t-mlp-baseline-pre", "t-tiny-trais-pre", "t-small-trais-pre"],
