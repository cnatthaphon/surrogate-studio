...
(async function () {
  ...
  var goodBbox = { drawflow: { Home: { data: {
    ...
    "2": { id:2, name:"augment_bbox_layer", data:{ hflipProb: 0.5, vflipProb: 0, seedLink:"", format:"x0y0x1y1", imageWidth:1, imageHeight:1 }, class:"augment_bbox_layer", html:"", typenode:false,
  ...
  var badImg = { drawflow: { Home: { data: {
    ...
    "2": { id:2, name:"reshape_layer", data:{ targetShape:"2,2,1" }, class:"reshape_layer", html:"", typenode:false,
           inputs:{ input_1:{ connections:[{ node:"1", output:"output_1" }] } }, outputs:{ output_1:{ connections:[{ node:"3", input:"input_1" }] } }, pos_x:100, pos_y:0 },
    "3": { id:3, name:"augment_image_layer", data:{ hflipProb: 0.5, vflipProb: 0, seedLink:"", layout:"nhwc" }, class:"augment_image_layer", html:"", typenode:false,
  ...
  var goodMaskFromTarget = { drawflow: { Home: { data: {
    "1": { id:1, name:"target_source_layer", data:{ targetKey:"mask", featureSize:16, targetShape:[4,4,1] }, class:"target_source_layer", html:"", typenode:false,
           inputs:{}, outputs:{ output_1:{ connections:[{ node:"2", input:"input_1" }] } }, pos_x:0, pos_y:0 },
    "2": { id:2, name:"augment_mask_layer", data:{ hflipProb: 0.5, vflipProb: 0, seedLink:"", layout:"nhwc" }, class:"augment_mask_layer", html:"", typenode:false,
           inputs:{ input_1:{ connections:[{ node:"1", output:"output_1" }] } }, outputs:{ output_1:{ connections:[{ node:"3", input:"input_1" }] } }, pos_x:100, pos_y:0 },
  ...
  var goodMaskFromImg = { drawflow: { Home: { data: {
    ...
    "2": { id:2, name:"reshape_layer", data:{ targetShape:"4,4,1" }, class:"reshape_layer", html:"", typenode:false,
           inputs:{ input_1:{ connections:[{ node:"1", output:"output_1" }] } }, outputs:{ output_1:{ connections:[{ node:"3", input:"input_1" }] } }, pos_x:100, pos_y:0 },
    "3": { id:3, name:"augment_mask_layer", data:{ hflipProb: 0.5, vflipProb: 0, seedLink:"", layout:"nhwc" }, class:"augment_mask_layer", html:"", typenode:false,
           inputs:{ input_1:{ connections:[{ node:"2", output:"output_1" }] } }, outputs:{ output_1:{ connections:[{ node:"4", input:"input_1" }] } }, pos_x:200, pos_y:0 },
    "4": { id:4, name:"flatten_layer", data:{}, class:"flatten_layer", html:"", typenode:false,
           inputs:{ input_1:{ connections:[{ node:"3", output:"output_1" }] } }, outputs:{ output_1:{ connections:[{ node:"5", input:"input_1" }] } }, pos_x:300, pos_y:0 },
  ...
  var paramsBbox = { drawflow: { Home: { data: {
    ...
    "3": { id:3, name:"augment_bbox_layer", data:{ hflipProb: 0.5, vflipProb: 0, seedLink:"", format:"x0y0x1y1", imageWidth:1, imageHeight:1 }, class:"augment_bbox_layer", html:"", typenode:false,
  ...
  var paramsImg = { drawflow: { Home: { data: {
    ...
    "3": { id:3, name:"reshape_layer", data:{ targetShape:"2,2,1" }, class:"reshape_layer", html:"", typenode:false,
           inputs:{ input_1:{ connections:[{ node:"2", output:"output_1" }] } }, outputs:{ output_1:{ connections:[{ node:"4", input:"input_1" }] } }, pos_x:100, pos_y:0 },
    "4": { id:4, name:"augment_image_layer", data:{ hflipProb: 0.5, vflipProb: 0, seedLink:"", layout:"nhwc" }, class:"augment_image_layer", html:"", typenode:false,
  ...
  // #178 (P1 from PR #76 round-4): name-only check let a label/mask
  // target_source with featureSize=4 pass into augment_bbox, because the
  // root's NAME was target_source_layer even though the targetKey wasn't
  // "bbox". Fix inspects targetKey on the root and rejects mismatches.
  console.log("Test 9a: target_source(targetKey='label', featureSize=4) -> augment_bbox must THROW (#178)");
  var labelAs4Bbox = { drawflow: { Home: { data: {
    "1": { id:1, name:"target_source_layer", data:{ targetKey:"label", featureSize:4 }, class:"target_source_layer", html:"", typenode:false,
           inputs:{}, outputs:{ output_1:{ connections:[{ node:"2", input:"input_1" }] } }, pos_x:0, pos_y:0 },
    "2": { id:2, name:"augment_bbox_layer", data:{ hflipProb: 0.5, vflipProb: 0, seedLink:"", format:"x0y0x1y1", imageWidth:1, imageHeight:1 }, class:"augment_bbox_layer", html:"", typenode:false,
           inputs:{ input_1:{ connections:[{ node:"1", output:"output_1" }] } }, outputs:{ output_1:{ connections:[{ node:"3", input:"input_1" }] } }, pos_x:100, pos_y:0 },
    "3": { id:3, name:"output_layer", data:{ target:"bbox", targetType:"bbox", loss:"mse", units:4, headType:"regression" }, class:"output_layer", html:"", typenode:false,
  ...
  expectThrow("target_source(label,fs=4) -> augment_bbox", function () {
    MBC.buildModelFromGraph(tf, labelAs4Bbox, {
      mode: "direct", featureSize: 4,
      allowedOutputKeys: [{ key: "bbox", featureSize: 4, headType: "regression" }],
      defaultTarget: "bbox", numClasses: 1, targetSize: 4,
    });
  }, /targetKey.*label|targetKey="label"|bbox.*coord/);

  console.log("Test 9b: target_source(targetKey='mask', featureSize=4) -> augment_bbox must THROW (#178)");
  var maskAs4Bbox = { drawflow: { Home: { data: {
    "1": { id:1, name:"target_source_layer", data:{ targetKey:"mask", featureSize:4 }, class:"target_source_layer", html:"", typenode:false,
           inputs:{}, outputs:{ output_1:{ connections:[{ node:"2", input:"input_1" }] } }, pos_x:0, pos_y:0 },
    "2": { id:2, name:"augment_bbox_layer", data:{ hflipProb: 0.5, vflipProb: 0, seedLink:"", format:"x0y0x1y1", imageWidth:1, imageHeight:1 }, class:"augment_bbox_layer", html:"", typenode:false,
           inputs:{ input_1:{ connections:[{ node:"1", output:"output_1" }] } }, outputs:{ output_1:{ connections:[{ node:"3", input:"input_1" }] } }, pos_x:100, pos_y:0 },
    "3": { id:3, name:"output_layer", data:{ target:"bbox", targetType:"bbox", loss:"mse", units:4, headType:"regression" }, class:"output_layer", html:"", typenode:false,
  ...
  expectThrow("target_source(mask,fs=4) -> augment_bbox", function () {
    MBC.buildModelFromGraph(tf, maskAs4Bbox, {
      mode: "direct", featureSize: 4,
      allowedOutputKeys: [{ key: "bbox", featureSize: 4, headType: "regression" }],
      defaultTarget: "bbox", numClasses: 1, targetSize: 4,
    });
  ...
  expectOk("target_source(bbox) -> augment_bbox", function () {
    MBC.buildModelFromGraph(tf, bboxKey, {
      mode: "direct", featureSize: 4,
      allowedOutputKeys: [{ key: "bbox", featureSize: 4, headType: "regression" }],
      defaultTarget: "bbox", numClasses: 1, targetSize: 4,
    });
