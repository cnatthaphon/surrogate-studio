(function (root, factory) {
  ...
  function _imagePaletteItems() {
    return [
      ...
      _paletteItem("addAugmentImageBtn", "augment_image", "AugmentImage", "Augment", { hflipProb: 0.5, vflipProb: 0, seedLink: "", layout: "auto" }),
      _paletteItem("addAugmentBboxBtn", "augment_bbox", "AugmentBbox", "Augment", { hflipProb: 0.5, vflipProb: 0, seedLink: "", imageWidth: 32, imageHeight: 32, format: "x0y0x1y1" }),
      _paletteItem("addAugmentMaskBtn", "augment_mask", "AugmentMask", "Augment", { hflipProb: 0.5, vflipProb: 0, seedLink: "", layout: "auto" }),
  ...
  function _aisTrajectoryPaletteItems() {
    return [
      _paletteItem("addWindowHistBtn", "window_hist", "WindowHistory", "Feature Nodes", { featureKey: "lat", windowSize: 16, stride: 1, lagMode: "contiguous", padMode: "none" }),
      _paletteItem("addHistBtn", "history", "History", "Feature Nodes", { featureKey: "lat" }),
      _paletteItem("addInputBtn", "input", "Input", "NN", { mode: "flat" }),
  ...
  registerSchema({
    ...
    label: "synthetic_segmentation",
    description: "Synthetic binary segmentation — predict pixel mask for random shapes",
    taskRecipeId: "segmentation_mask",
    dataset: {
      id: "synthetic_segmentation",
      label: "Synthetic Segmentation Images",
      sampleType: "image",
      splitUnit: "sample",
      splitDefaults: { mode: "random", train: 0.70, val: 0.15, test: 0.15 },
      metadata: {
    ...
    model: {
      outputs: [
        { key: "mask", label: "Segmentation mask (per-pixel)", headType: "segmentation" }
      ],
      params: [],
      presets: [],
      metadata: {
    ...
    preconfig: {
      dataset: { defaultModuleId: "synthetic_segmentation", splitDefaults: { mode: "random", train: 0.70, val: 0.15, test: 0.15 } },
      model: { defaultPreset: "" },
    }
  });
      ...
      metadata: {
        featureNodes: {
          historySeries: [
            ...
            { key: "sog", label: "Speed Over Ground" },
